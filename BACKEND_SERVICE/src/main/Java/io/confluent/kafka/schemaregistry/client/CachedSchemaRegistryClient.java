...
public class CachedSchemaRegistryClient implements SchemaRegistryClient {
  ...
  private int getVersionFromRegistry(String subject, Schema schema)
    ...
    log.info(response.getVersion().toString());
  ...
  @Override
  public io.confluent.kafka.schemaregistry.client.SchemaMetadata getSchemaMetadata(String subject, int version) throws IOException, RestClientException {
    io.confluent.kafka.schemaregistry.client.rest.entities.Schema response
      = restService.getVersion(subject, version);
    int id = response.getId();
    String schema = response.getSchema();
    return new io.confluent.kafka.schemaregistry.client.SchemaMetadata(id, version, schema);
  }

  @Override
  public synchronized io.confluent.kafka.schemaregistry.client.SchemaMetadata getLatestSchemaMetadata(String subject)
      throws IOException, RestClientException {
    io.confluent.kafka.schemaregistry.client.rest.entities.Schema response
