...
public class MockSchemaRegistryClient implements SchemaRegistryClient {
  ...
  @Override
  public synchronized io.confluent.kafka.schemaregistry.client.SchemaMetadata getSchemaMetadata(String subject, int version) {
    ...
    return new io.confluent.kafka.schemaregistry.client.SchemaMetadata(id, version, schemaString);
  }
